module.exports = {
  translation: {
    ...
    APPOINTMENT_CONFIRM_COMPLETED: [
      'あなたの%sの%sのアポイントが取得されました。確認メールが送信されます。キャンセルまたは再度スケジュールするには、確認メールに返信してください。ありがとうございました。',
    ],
    TIME_AVAILABLE: [
      '%sは利用可能です。予約しますか。',
    ],
    ...
    TIME_NOT_AVAILABLE: [
      'すみませんが、%sは利用できません。他の時間にしますか。',
    ],
    TIME_NOT_AVAILABLE_REPROMPT: [
      '他の時間にしますか。',
    ],
    APPOINTMENT_TITLE: '%sのアポイント',
    APPOINTMENT_DESCRIPTION: 'これは %s の%s の電話アポイントです。%sに電話します。このアポイントをキャンセルまたは変更する必要がある場合は、このメールに返信してください。',
    EMAIL_SUBJECT: '%sの%sのアポイント',
    EMAIL_TEXT: 'これは %s の%s の電話アポイントです。%sに電話します。このアポイントをキャンセルまたは変更する必要がある場合は、このメールに返信してください。',
    ...
    PERMISSIONS_REQUIRED: '予約をして確認をするためには、%sは名前、メールアドレス、電話番号にアクセスする必要があります。Alexaアプリからユーザープロフィールへのアクセス権限を有効にしてください。',
